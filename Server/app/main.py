...
from app.api.visual import animation, pipeline as visual_pipeline_router
...
app.include_router(visual_pipeline_router.router, prefix="/api", tags=["Visual Pipeline"])
