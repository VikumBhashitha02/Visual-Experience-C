...
DEFAULT_SIZES = {
    "volcano": 80, "mountain": 120, "ocean": 150, "cloud": 40, "rock": 40,
    ...
    "bolt": 35, "thermometer": 50, "wave": 100,
}

DEFAULT_COLORS = {
    "volcano": "#FF5722", "mountain": "#795548", "ocean": "#2196F3", "cloud": "#E0E0E0", "rock": "#78909C",
    ...
    "glucose": "#FF9800", "bolt": "#FFEB3B", "thermometer": "#F44336", "wave": "#2196F3",
}
...
POSITION_ZONES = {
    ...
    "rock": {"x": 400, "y": 450, "zone": "bottom"},
    "bolt": {"x": 400, "y": 200, "zone": "center"},
    "thermometer": {"x": 100, "y": 300, "zone": "left"},
    "wave": {"x": 400, "y": 450, "zone": "bottom"},
}
