...
def calculate_scene_duration(scene_data: dict) -> int:
    ...
    # Cap actor count at 8 for multiplier lookup; more actors ≠ indefinitely longer scenes
    capped_count = min(num_actors, 8)
    multiplier = ACTOR_COUNT_DURATION_MULTIPLIER.get(capped_count, 1.7)
